...
writer = SummaryWriter(logdir=os.path.join(save_path, "log_{}_{}_{}_random".format(prune_percent, mode, prune_itr)))
...
while itr_index <= train_itrs:
    ...
    for (inputs, targets) in train_loader:
        ...
        if itr_index % eval_itrs == 0:
            ...
            torch.save(state, os.path.join(save_path, "ckpt_{}_{}_{}_random.pkl".format(prune_percent, mode, prune_itr)))
            writer.flush()
