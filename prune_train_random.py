...
writer = SummaryWriter(logdir=os.path.join(save_path, "log_{}_{}_random".format(prune_percent, mode)))
    ...
    for (inputs, targets) in train_loader:
        ...
        if itr_index % eval_itrs == 0:
            ...
            if test_acc > best_test_acc:
                ...
                torch.save(state, os.path.join(save_path, "ckpt_best_{}_{}_random.pkl".format(prune_percent, mode)))
